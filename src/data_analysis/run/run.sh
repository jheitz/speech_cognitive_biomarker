...
## SVR regression results on individual spontaneous speech tasks: journaling, picnicScene, cookieTheft ##
...
## With consent filters: using only the participants who consented to the use of their data for further, non-commercial research (n=837, Development set: 658 participants, Holdout Test set : 166 participants)) ##
...
## Control analysis including socioeconomic status as additional demographic variable
...
### Detection of cognitive low performers (SVM classification) ###
